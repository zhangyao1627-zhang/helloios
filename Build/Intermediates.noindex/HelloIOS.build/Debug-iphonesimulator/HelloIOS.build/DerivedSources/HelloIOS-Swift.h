...
#ifndef HELLOIOS_SWIFT_H
#define HELLOIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HelloIOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8HelloIOS11AppDelegate")
...
SWIFT_CLASS("_TtC8HelloIOS13SceneDelegate")
...
SWIFT_CLASS("_TtC8HelloIOS14ViewController")
